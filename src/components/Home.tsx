...
const Home = (props: IHomeProps) => {
    ...
    return (
        <>
            ...
            <p>Ziel ist es darüber Erkenntnisse zu erlangen wie <b>Corona-Fälle kleinräumig auf Stadtteilebene innerhalb Kölns</b> verteilt sind und inwiefern <b>freiwillig erhobene Daten</b> einen Beitrag dazu leisten können.</p>
